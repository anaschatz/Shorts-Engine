...
try {
  ...
  const summary = {
    ...
    offsideOutcomeAccuracy: report.aggregate.offsideOutcomeAccuracy,
    disallowedGoalIncluded: report.aggregate.disallowedGoalIncluded,
    decisionContextCoverage: report.aggregate.decisionContextCoverage,
    captionOutcomeAlignment: report.aggregate.captionOutcomeAlignment,
    postGoalWindowCoverage: report.aggregate.postGoalWindowCoverage,
    validGoalRecall: report.aggregate.validGoalRecall,
    lateGoalRecall: report.aggregate.lateGoalRecall,
    falseGoalRate: report.aggregate.falseGoalRate,
    offsideExclusionAccuracy: report.aggregate.offsideExclusionAccuracy,
    noGoalExclusionAccuracy: report.aggregate.noGoalExclusionAccuracy,
    validGoalsOnlyCoverage: report.aggregate.validGoalsOnlyCoverage,
    validGoalOnlyFillerRate: report.aggregate.validGoalOnlyFillerRate,
    fillerRate: report.aggregate.fillerRate,
    ...
    ocrEvidenceCoverage: report.aggregate.ocrEvidenceCoverage,
    ...
    matchEventTruthValidGoalRecall: report.aggregate.matchEventTruthValidGoalRecall,
    matchEventTruthLateGoalRecall: report.aggregate.matchEventTruthLateGoalRecall,
    matchEventTruthDisallowedClassification: report.aggregate.matchEventTruthDisallowedClassification,
    matchEventTruthFalseGoalRate: report.aggregate.matchEventTruthFalseGoalRate,
