...
try {
  ...
  const summary = {
    ...
    captionSpecificityScore: report.aggregate.metrics.captionSpecificityScore,
    reactionAsSupportScore: report.aggregate.metrics.reactionAsSupportScore,
    weakEvidenceNeutralityScore: report.aggregate.metrics.weakEvidenceNeutralityScore,
    providerFallbackRate: report.aggregate.metrics.providerFallbackRate,
