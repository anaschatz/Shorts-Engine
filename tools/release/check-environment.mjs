...
const ENV_CONTRACT = Object.freeze([
  ...
  { name: "SHORTSENGINE_YOUTUBE_SMOKE_URL", category: "Remote URL ingest", required: false, defaultValue: "", type: "url", secret: false },
  { name: "SHORTSENGINE_YOUTUBE_SMOKE_BASE_URL", category: "Remote URL ingest", required: false, defaultValue: "", type: "url", secret: false },
  ...
  { name: "SHORTSENGINE_SCOREBOARD_OCR_QA_ARTIFACTS", category: "Scoreboard OCR", required: false, defaultValue: "false", type: "boolean", secret: false },
  { name: "SHORTSENGINE_SCOREBOARD_OCR_QA_ARTIFACT_RETENTION", category: "Scoreboard OCR", required: false, defaultValue: "8", type: "integer", min: 1, max: 50, secret: false },
  ...
  { name: "SHORTSENGINE_LOCAL_WHISPER_MODE", category: "Transcription/AI provider", required: false, defaultValue: "auto", type: "boolean-auto", secret: false },
  { name: "SHORTSENGINE_LOCAL_WHISPER_PYTHON_BIN", category: "Transcription/AI provider", required: false, defaultValue: "python3", type: "command", secret: false },
  { name: "SHORTSENGINE_LOCAL_WHISPER_MODEL", category: "Transcription/AI provider", required: false, defaultValue: "base", type: "string", secret: false },
  { name: "SHORTSENGINE_LOCAL_WHISPER_DEVICE", category: "Transcription/AI provider", required: false, defaultValue: "cpu", type: "string", secret: false },
  { name: "SHORTSENGINE_LOCAL_WHISPER_COMPUTE_TYPE", category: "Transcription/AI provider", required: false, defaultValue: "int8", type: "string", secret: false },
  { name: "SHORTSENGINE_LOCAL_WHISPER_TIMEOUT_MS", category: "Transcription/AI provider", required: false, defaultValue: "180000", type: "integer", min: 1000, max: 900000, secret: false },
...
function validateScoreboardOcrReadiness(env, numeric) {
  ...
  return {
    ...
    qaArtifactsEnabled: boolFromEnv(rawValue(env, "SHORTSENGINE_SCOREBOARD_OCR_QA_ARTIFACTS")) ||
      boolFromEnv(rawValue(env, "SHORTSENGINE_OCR_QA_ARTIFACTS")),
    qaArtifactRetention: numeric.SHORTSENGINE_SCOREBOARD_OCR_QA_ARTIFACT_RETENTION ||
      numeric.SHORTSENGINE_OCR_QA_ARTIFACT_RETENTION,
...
function checkEnvironment(options = {}) {
  ...
  const summary = {
    ...
    youtubeIngest: {
      ...
      smokeUrlConfigured: Boolean(rawValue(env, "SHORTSENGINE_YOUTUBE_SMOKE_URL")),
