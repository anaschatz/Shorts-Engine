...
const REQUIRED_TEST_IDS = Object.freeze({
  ...
  youtubeRecoveryActions: "youtube-recovery-actions",
  youtubeRetryIngestButton: "youtube-retry-ingest-button",
  youtubeUseAnotherButton: "youtube-use-another-button",
  youtubeUploadMp4FallbackButton: "youtube-upload-mp4-fallback-button",
  ...
  reviewApproveButton: "review-approve-button",
...
function collectStaticBrowserChecks({ app, css, html, manual }) {
  ...
  addCheck(checks, "youtube_validate_retry_only_contract", /validateYoutubeBtn\.hidden = !showValidationFallback/.test(app) && /Retry validation/.test(app));
