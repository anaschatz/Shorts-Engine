...
function safeRenderPolishQA(value) {
  ...
  return {
    ...
    cropKeyframeCount: Number.isFinite(Number(value.cropKeyframeCount)) ? Number(value.cropKeyframeCount) : null,
    ...
    splitLayoutCaptionCount: Number.isFinite(Number(value.splitLayoutCaptionCount)) ? Number(value.splitLayoutCaptionCount) : null,
