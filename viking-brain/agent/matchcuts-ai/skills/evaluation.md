...
- use `SHORTSENGINE_OCR_QA_ARTIFACTS=1 npm run ocr:smoke` only for operator crop QA; evaluate safe relative crop refs, not raw OCR text, full frames, paths or provider output.
