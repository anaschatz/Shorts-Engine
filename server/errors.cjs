...
const SAFE_MESSAGES = Object.freeze({
  ...
  FOOTBALL_REVIEW_ALREADY_DECIDED: "This football review has already been completed.",
  FOOTBALL_REVIEW_CANDIDATE_INVALID: "The football review candidate is invalid.",
  FOOTBALL_REVIEW_CONFLICT: "This football review request conflicts with an earlier request.",
  FOOTBALL_REVIEW_NOT_FOUND: "The requested football review was not found.",
  FOOTBALL_REVIEW_NOT_REQUIRED: "This football moment does not require human review.",
  FOOTBALL_REVIEW_REQUIRED: "Human review is required before this football render can be downloaded.",
  FOOTBALL_REVIEW_RIGHTS_REQUIRED: "Confirmed footage rights are required before approving this candidate.",
  FOOTBALL_REVIEW_SOURCE_INVALID: "The football review source is incomplete or no longer current.",
  FOOTBALL_REVIEW_STALE: "The football review is stale. Refresh before submitting a decision.",
  FOOTBALL_REVIEW_STATE_INVALID: "The football review moved through an invalid state transition.",
  ...
  JOB_TIMEOUT: "The job exceeded its server-side processing time limit.",
  ...
  RENDER_QUOTA_EXCEEDED: "A server-side render or provider budget limit has been reached.",
  ...
  CSRF_INVALID: "Request verification failed.",
  ...
  OIDC_AUTH_FAILED: "Sign-in could not be completed.",
  ...
  TTS_AUDIO_INVALID: "AI narration audio is invalid.",
  TTS_AUDIO_TAMPERED: "AI narration audio does not match its provenance.",
  TTS_COMMERCIAL_ATTESTATION_REQUIRED: "Commercial-use attestation is required for AI narration.",
  TTS_CREDENTIALS_MISSING: "The configured TTS provider credentials are missing.",
  ...
  TTS_PROVIDER_UNSUPPORTED: "The TTS provider is unsupported.",
  TTS_PROVENANCE_INVALID: "AI narration provenance is invalid.",
  TTS_PROVENANCE_MISMATCH: "AI narration provenance does not match its artifacts.",
  TTS_PROVENANCE_MISSING: "AI narration provenance is missing.",
  TTS_SCRIPT_NOT_APPROVED: "The AI narration script is not approved.",
  TTS_SCRIPT_TAMPERED: "The approved script does not match AI narration provenance.",
  TTS_VOICE_PROHIBITED: "Cloned or impersonated voices are prohibited.",
