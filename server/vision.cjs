...
function summarizeVisualSignals(input = {}) {
  ...
  return {
    ...
    refereeNoGoalSignal: safeSummaryValue(windows, "referee_no_goal_signal"),
    refereeGoalSignal: safeSummaryValue(windows, "referee_goal_signal"),
    varScreen: safeSummaryValue(windows, "var_screen"),
    varCheckGraphic: safeSummaryValue(windows, "var_check_graphic"),
    varDecisionGraphic: safeSummaryValue(windows, "var_decision_graphic"),
    scoreboardNoGoal: safeSummaryValue(windows, "scoreboard_no_goal"),
    scoreboardGoalRemoved: safeSummaryValue(windows, "scoreboard_goal_removed"),
    scoreboardGoalConfirmed: safeSummaryValue(windows, "scoreboard_goal_confirmed"),
    replayLine: safeSummaryValue(windows, "replay_line"),
    offsideLineReplay: safeSummaryValue(windows, "offside_line_replay"),
    replayAngle: safeSummaryValue(windows, "replay_angle"),
    refereeSignal: safeSummaryValue(windows, "referee_signal"),
    crowdConfusion: safeSummaryValue(windows, "crowd_confusion"),
    celebrationAfterWhistle: safeSummaryValue(windows, "celebration_after_whistle"),
    goalClaimAllowed: false,
  };
}
