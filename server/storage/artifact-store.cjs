...
const AREA_BY_TYPE = Object.freeze({
  ...
  content_brief: "artifacts",
  claim_ledger: "artifacts",
  narrative_script: "artifacts",
  storyboard: "artifacts",
  approval_bundle: "artifacts",
  narration_audio: "audio",
  narration_manifest: "artifacts",
  narration_alignment: "artifacts",
  caption_manifest: "artifacts",
  caption_ass: "artifacts",
  audio_normalization_report: "artifacts",
  timeline_ir: "artifacts",
  animation_timing_context: "artifacts",
  animation_scene_dsl_plan: "artifacts",
  animation_plan: "artifacts",
  animation_ir: "artifacts",
  animation_render_manifest: "artifacts",
  animation_qa_report: "artifacts",
  animation_motion_review: "artifacts",
  animation_motion_calibration: "artifacts",
  scene_keyframe: "artifacts",
  render_manifest: "artifacts",
  qa_report: "artifacts",
  contact_sheet: "artifacts",
  rights_manifest: "artifacts",
  invalidation_report: "artifacts",
  export_metadata: "artifacts",
  provenance_report: "artifacts",
  publish_approval: "artifacts",
});
...
const CONTENT_TYPE_BY_TYPE = Object.freeze({
  ...
  content_brief: "application/json",
  claim_ledger: "application/json",
  narrative_script: "application/json",
  storyboard: "application/json",
  approval_bundle: "application/json",
  narration_audio: "audio/wav",
  narration_manifest: "application/json",
  narration_alignment: "application/json",
  caption_manifest: "application/json",
  ...
  animation_scene_dsl_plan: "application/json",
  ...
  animation_motion_review: "application/json",
  animation_motion_calibration: "application/json",
  ...
  invalidation_report: "application/json",
  export_metadata: "application/json",
  provenance_report: "application/json",
  publish_approval: "application/json",
});
