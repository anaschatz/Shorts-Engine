...
- [Budget Friendly](https://www.youtube.com/@BudgetFriendlyShorts) is the public
  channel hosting the documented motivational example. This does **not** claim
  that every video on the channel was generated by ShortsEngine.
- [Why Cynicism Never Helps You | Andrew Huberman #Shorts](https://www.youtube.com/shorts/3sQmO4611mo)
  is a verified public motivational Short.
- The supplied [football Short](https://www.youtube.com/shorts/1yubCngacLk)
  was unavailable during the latest verification and is not presented as a
  currently public output.
- **The GPS clocks that looked haunted** is a verified local narrated-animation
  technical final — public upload pending.
