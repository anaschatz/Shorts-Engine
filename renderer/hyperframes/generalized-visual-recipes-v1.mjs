...
[data-visual-scene]{--scene-bg:#08090c;--scene-surface:#171922;--scene-line:#cbd5e1;--scene-accent:#fbbf24;--scene-secondary:#fb7185}.surface{fill:var(--scene-surface);stroke:var(--scene-line);stroke-width:3}.panel-frame{fill-opacity:.88}.helper-surface{fill:var(--scene-surface);fill-opacity:.95;stroke:var(--scene-line);stroke-width:2}.line-art{fill:none;stroke:var(--scene-line);stroke-width:5;stroke-linecap:round;stroke-linejoin:round}.accent-stroke{fill:none;stroke:var(--scene-accent);stroke-width:7;stroke-linecap:round;stroke-linejoin:round}.grounded-copy{fill:#f8fafc}.heading-copy{fill:var(--scene-accent);letter-spacing:.4px}.secondary-copy,.helper-copy{fill:#cbd5e1}.badge-surface{fill:var(--scene-surface);stroke:var(--scene-accent);stroke-width:2}.badge-copy{fill:var(--scene-accent);letter-spacing:2px}.focus-ring{fill:none;stroke:var(--scene-accent);stroke-width:4;filter:url(#soft-glow)}
