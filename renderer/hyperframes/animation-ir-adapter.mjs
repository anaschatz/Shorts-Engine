...
<meta data-composition-id="wow-signal-benchmark" data-width="${ir.width}" data-height="${ir.height}" data-font-sha256="${FONT_SHA256}">
<style>
...
<main id="wow-root" class="composition" data-composition-id="wow-signal-benchmark" data-start="0" data-duration="${durationSeconds}" data-width="${ir.width}" data-height="${ir.height}">
...
<g id="header" data-entity-id="signal_header" data-caption-policy="avoid"><text x="54" y="70" fill="#67e8f9" class="kicker">SIGNAL LAB · 1977</text><text x="54" y="121" fill="#f1f5f9" class="title">THE SIGNAL THAT</text><text x="54" y="168" fill="#f1f5f9" class="title">APPEARED ONCE</text></g>
<g id="camera-stage">
 <g id="grid-group" data-entity-id="signal_grid" data-caption-policy="avoid">
  ...
  <rect x="42" y="210" width="636" height="610" rx="28" fill="url(#grid-pattern)"/>
  ...
  <text x="72" y="246" fill="#64748b" class="axis">RADIO NOISE</text>
  <text x="648" y="795" text-anchor="end" fill="#64748b" class="axis">OBSERVATION</text>
 </g>
 ...
 <g id="frequency-label" opacity="0" data-entity-id="signal_frequency" data-caption-policy="avoid"><rect x="263" y="250" width="194" height="52" rx="26" fill="#083344" stroke="#22d3ee" stroke-width="2"/><text x="360" y="284" text-anchor="middle" fill="#cffafe" class="label">1420 MHz</text></g>
 ...
 <g id="evidence-label" opacity="0" data-entity-id="evidence_node" data-caption-policy="avoid"><text x="360" y="506" text-anchor="middle" fill="#ecfeff" font-size="17" letter-spacing="3">EVIDENCE</text><text x="360" y="542" text-anchor="middle" fill="#67e8f9" font-size="25">6EQUJ5</text></g>
 <g id="reasoning-bridge" opacity="0" data-entity-id="reasoning_bridge" data-caption-policy="avoid"><line id="reason-left" x1="360" y1="610" x2="360" y2="610" stroke="#67e8f9" stroke-width="4"/><line id="reason-right" x1="360" y1="610" x2="360" y2="610" stroke="#fbbf24" stroke-width="4"/><circle id="reason-left-dot" cx="360" cy="610" r="8" fill="#67e8f9"/><circle id="reason-right-dot" cx="360" cy="610" r="8" fill="#fbbf24"/><text x="150" y="658" text-anchor="middle" fill="#cffafe" font-size="17" letter-spacing="1">ONE OBSERVATION</text><text id="reason-not-equal" x="360" y="660" text-anchor="middle" fill="#fde68a" font-size="34">≠</text><text x="570" y="658" text-anchor="middle" fill="#fde68a" font-size="19" letter-spacing="2">PROOF</text></g>
 <g id="payoff-panel" opacity="0" data-entity-id="payoff_label" data-caption-policy="avoid"><circle id="payoff-field" cx="360" cy="515" r="110" fill="url(#payoff)"/><text x="360" y="690" text-anchor="middle" fill="#fde68a" font-size="44">UNEXPLAINED</text><text x="360" y="738" text-anchor="middle" fill="#cbd5e1" font-size="26" letter-spacing="3">IS NOT PROOF</text><line id="payoff-line" x1="222" y1="766" x2="498" y2="766" stroke="#fbbf24" stroke-width="3" stroke-dasharray="276" stroke-dashoffset="276"/></g>
</g>
<g id="narrative-timeline" data-entity-id="narrative_timeline" data-caption-policy="avoid">
 ...
 <g fill="#64748b" font-size="13" letter-spacing="1"><text x="84" y="912">OBSERVE</text><text x="244" y="912" text-anchor="middle">SIGNAL</text><text x="430" y="912" text-anchor="middle">EVIDENCE</text><text x="636" y="912" text-anchor="end">CONCLUSION</text></g>
...
function renderFrame(rawFrame){
 ...
 const narrativeProgress=clamp(frame/284),cursorX=84+552*narrativeProgress;byId("timeline-active").setAttribute("x2",cursorX.toFixed(3));byId("timeline-cursor").setAttribute("transform","translate("+cursorX.toFixed(3)+" 0)");
