...
function renderFrame(rawFrame){
 ...
 const morph=progress(frame,"morph_path:signal_wave"),morphed=morphPath(morph);byId("wave").setAttribute("d",morphed);byId("wave-glow").setAttribute("d",morphed);byId("wave-glow").setAttribute("opacity",(.18*draw*(1-.55*morph)).toFixed(4));
